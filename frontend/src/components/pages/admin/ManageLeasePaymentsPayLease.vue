    ...
    <Background>
      <div id="tableContentArea">
        <div id="backButtonArea">
          ...
          <p id="contentHeader">Pay Lease</p>
        </div>

        <div id="actionContentArea">
          <div id="infoArea1">
            <p class="infoLabel">Drone Owner ID: 17</p>
            <p class="infoLabel">Drone Size Class: Medium</p>
            <p class="infoLabel">Amount Due: $50.00</p>
          </div>

          <div id="infoArea2">
            <div class="infoWrapper">
              <p class="infoLabel">Current Balance:</p>
              <p class="infoValue">$812,523.32</p>
            </div>
            <div class="infoWrapper">
              <p class="infoLabel">New Balance:</p>
              <p class="infoValue">$912,523.32</p>
            </div>
          </div>
        </div>

        <div id="buttonArea">
          <VueButton>Pay Lease</VueButton>
        </div>
      </div>
    </Background>
  </header>
...
export default {
name: 'ManageLeasePaymentsPayLease',
components: {
  AppHeader,
  AppFooter,
  Background,
