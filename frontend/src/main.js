...
const router = createRouter({
    ...
    routes:[
        ...
        { path: '/admin/manageInventory/restock', component: ManageInventoryRestock},
        ...
        { path: '/admin/manageMenu/edit', component: ManageMenuEdit},
        { path: '/admin/manageMenu/remove', component: ManageMenuRemove},
