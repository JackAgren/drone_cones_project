...
1. In homepage, click **Login** and enter following credentials on Login page:
    ...
    Press the **Login** button when ready.<br/>
...
1. Now click **Restock**.<br/>
    <img src="screenshots/admin-tools-manage-inventory.png" width="640" height="360"/>

1. Click on an entry to select it (i.e.**Chocolate**).  Then, click the **Restock** button below the item table.<br/>
    <img src="screenshots/inventory-management.png" width="640" height="360"/>
1. Enter the quantity to purchase in the provided input.  Click on the **Restock** button when ready. <br/>
